  ...
  return (
    <div className="space-y-2">
      ...
      <div className="group flex items-start gap-2">
        <div className="flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold text-white bg-orange-500">
          ξ
        </div>
        ...
        <div className="ml-9 mr-3 mb-1 pl-4 border-l border-gray-200 space-y-0.5">
          ...
          {turn.assistantMessages.some(m => m.blocks.some(b => b.type === 'text' && !b.subtype)) && (
            <div className="flex items-center gap-2 py-0.5">
              <div className="flex-shrink-0 w-4 h-4 rounded-full flex items-center justify-center text-[10px] font-bold text-white bg-orange-400">ξ</div>
