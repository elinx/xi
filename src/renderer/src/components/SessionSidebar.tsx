                ...
                : isMoveUnderMode && isMoveUnderDropTarget
                  ...
                  : isActive
                    ? isCompleted
                      ...
                      : 'bg-gray-100 text-gray-900'
                    : isCompleted
                      ? 'text-gray-400 hover:bg-blue-50/60 hover:text-gray-500 border-l-[3px] border-l-transparent hover:border-l-blue-400'
                      : hiddenCount > 0
                        ? 'bg-gray-50/80 text-gray-700 hover:bg-blue-50/60 hover:text-gray-800 border-l-[3px] border-l-transparent hover:border-l-blue-400'
                        : 'text-gray-600 hover:bg-blue-50/60 hover:text-gray-800 border-l-[3px] border-l-transparent hover:border-l-blue-400'
        }`}
        onClick={() => {
