          ...
          <div className="px-8 py-10 text-center">
            ...
            <div className="mt-8 flex flex-col items-center gap-2.5">
              <button
                ...
                className="rounded-lg bg-blue-600 px-8 py-2 text-sm font-medium text-white hover:bg-blue-500 transition-colors duration-150"
              >
                Get Started
              </button>
              <button
                onClick={onSkip}
                className="rounded-lg px-4 py-1.5 text-xs text-gray-400 hover:text-gray-600 transition-colors duration-150"
              >
                Skip for now
              </button>
            </div>
          ...
          <div className="flex flex-col flex-1 min-h-0">
            ...
            {hasConfiguredProvider && (
              <div className="px-6 py-4 flex-shrink-0 border-t border-gray-100">
                <button
                  onClick={onSkip}
                  className="w-full rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-medium text-white hover:bg-blue-500 transition-colors duration-150"
                >
                  Start Using Xi
                </button>
              </div>
